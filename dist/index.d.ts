...
export declare function tellWorker<A>(worker: Worker, topic: string, payload?: A): void;
export declare function askWorker<A, B>(worker: Worker, msg: WorkerMessage<A>): Promise<B>;
...
export declare function init(payload: InitRequest): Promise<InitResponse>;
export declare function situation(payload: SituationRequest): Promise<SituationResponse>;
export declare function move(payload: MoveRequest): Promise<MoveResponse>;
export declare function drop(payload: DropRequest): Promise<MoveResponse>;
export declare function threefoldTest(payload: ThreefoldTestRequest): Promise<ThreefoldTestResponse>;
export declare function pgnDump(payload: PgnDumpRequest): Promise<PgnDumpResponse>;
